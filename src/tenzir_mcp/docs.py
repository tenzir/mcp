            ...
            if potential_docs_path.exists():
                ...
                try:
                    ...
                    if hasattr(docs_pkg, "_path"):
                        ...
                        raise NotImplementedError("Wheel-based docs access not yet implemented")
                except (ModuleNotFoundError, FileNotFoundError):
                    raise FileNotFoundError(f"Documentation not found at {potential_docs_path}. "
                                           "Run 'make update-docs' or rebuild the package.")
                
            if not self._docs_root.exists():
                raise FileNotFoundError(f"Documentation not found at {self._docs_root}. "
                                       "Run 'make update-docs' or rebuild the package.")
